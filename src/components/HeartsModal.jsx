  ...
  return (
    <div className="hearts-modal-overlay animate-fade-in" onClick={onClose}>
      <div className="hearts-modal-card" onClick={(e) => e.stopPropagation()}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', marginBottom: '16px', marginTop: '12px' }}>
          ...
          <h2 className="hearts-modal-title" style={{ fontSize: '20px', fontWeight: '900', color: 'var(--color-text)', margin: 0 }}>
