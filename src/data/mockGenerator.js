...
const verbToBeQuestions = {
  ...
  medium1: [
    {
      question: "The news about the company's layoffs ___ quite shocking to everyone in the office.",
    ...
    {
      question: "The team ___ working on their projects in separate rooms.",
      options: ["are", "is", "am", "be"],
      correctAnswer: "are",
    ...
    {
      question: "Neither of my parents ___ going to the meeting tomorrow.",
      options: ["is", "are", "am", "be"],
      correctAnswer: "is",
    ...
    {
      question: "A number of students ___ absent today due to the storm.",
    ...
    {
      question: "The number of students in the classroom ___ thirty.",
    ...
    {
      question: "Politics ___ a complicated subject for many.",
      options: ["is", "are", "were", "be"],
      correctAnswer: "is",
    ...
    {
      question: "Ten dollars ___ a high price for a cup of coffee.",
      options: ["is", "are", "were", "be"],
      correctAnswer: "is",
    ...
    {
      question: "The crowd ___ shouting enthusiastically at the concert last night.",
    ...
    {
      question: "Bread and butter ___ my favorite breakfast.",
      options: ["is", "are", "were", "be"],
      correctAnswer: "is",
    ...
    {
      question: "Every boy and girl ___ given a book.",
  ...
  medium2: [
    {
      question: "Either the supervisor or the workers ___ responsible.",
      options: ["are", "is", "was", "be"],
      correctAnswer: "are",
    ...
    {
      question: "A pack of wolves ___ seen in the forest yesterday.",
      options: ["was", "were", "are", "is"],
      correctAnswer: "was",
    ...
    {
      question: "None of the information ___ helpful.",
      options: ["was", "were", "are", "be"],
      correctAnswer: "was",
    ...
    {
      question: "Three-quarters of the city ___ destroyed.",
      options: ["was", "were", "are", "be"],
      correctAnswer: "was",
    ...
    {
      question: "Most of the apples ___ rotten.",
    ...
    {
      question: "There ___ several issues to resolve.",
      options: ["are", "is", "was", "be"],
      correctAnswer: "are",
    ...
    {
      question: "Mumps ___ a viral disease.",
      options: ["is", "are", "were", "be"],
      correctAnswer: "is",
  ...
  hard1: [
    {
      question: "If he ___ a bit wiser, he wouldn't make such mistakes.",
      options: ["were", "was", "is", "be"],
      correctAnswer: "were",
    ...
    {
      question: "I demand that she ___ present at the hearing.",
    ...
    {
      question: "It is vital that he ___ informed immediately.",
    ...
    {
      question: "He talks as if he ___ the boss here, but he is only a trainee.",
      options: ["were", "was", "is", "be"],
      correctAnswer: "were",
    ...
    {
      question: "No sooner had they arrived than they ___ told to leave.",
    ...
    {
      question: "Many a student ___ failed the test because of carelessness.",
    ...
    {
      question: "Not only the teacher but also the students ___ attending the seminar.",
      options: ["are", "is", "was", "be"],
      correctAnswer: "are",
    ...
    {
      question: "The CEO, along with his assistants, ___ attending the meeting.",
      options: ["is", "are", "were", "be"],
      correctAnswer: "is",
    ...
    {
      question: "The staff ___ requested to wear their badges.",
      options: ["are", "is", "was", "be"],
      correctAnswer: "are",
    ...
    {
      question: "What ___ the primary reasons for this project's collapse?",
      options: ["were", "was", "is", "be"],
      correctAnswer: "were",
  ...
  hard2: [
    {
      question: "So intense ___ the debate that the meeting was extended.",
      options: ["was", "were", "are", "be"],
      correctAnswer: "was",
    ...
    {
      question: "Hardly ___ there any doubt left after the final presentation.",
    ...
    {
      question: "The class ___ unable to agree on the dates for the exam.",
      options: ["were", "was", "is", "be"],
      correctAnswer: "were",
    ...
    {
      question: "Every file and folder ___ examined before the system audit.",
      options: ["was", "were", "are", "be"],
      correctAnswer: "was",
    ...
    {
      question: "The majority of the research ___ invalid.",
      options: ["was", "were", "are", "be"],
      correctAnswer: "was",
    ...
    {
      question: "A variety of options ___ presented to the board.",
      options: ["were", "was", "is", "be"],
      correctAnswer: "were",
    ...
    {
      question: "To read widely and to write eloquently ___ essential skills.",
      options: ["are", "is", "was", "be"],
      correctAnswer: "are",
    ...
    {
      question: "Where ___ the scissors I lent you yesterday?",
      options: ["are", "is", "was", "be"],
      correctAnswer: "are",
    ...
    {
      question: "The coordinates of the target ___ transmitted via satellite.",
      options: ["were", "was", "is", "be"],
      correctAnswer: "were",
    ...
    {
      question: "___ there any clean towels in the cabinet?",
      options: ["Are", "Is", "Was", "Be"],
      correctAnswer: "Are",
...
export function getMockQuestions(categoryId, topicId, levelId, topicTitle) {
  ...
  const staticGeneralQuestions = {
    easy: [
      ...
      {
        question: "My father doesn't ___ coffee.",
      ...
      {
        question: "We have been studying English ___ three years.",
      ...
      {
        question: "I am not interested ___ playing games.",
      ...
      {
        question: "Please don't make so much noise. I ___ trying to study.",
        options: ["am", "is", "are", "be"],
        correctAnswer: "am",
    ...
    medium1: [
      ...
      {
        question: "He completed the course ___ the difficulties.",
      ...
      {
        question: "The teacher made us ___ the entire essay.",
      ...
      {
        question: "I wish I ___ more time to study last week.",
      ...
      {
        question: "She suggested ___ a movie instead of going out.",
      ...
      {
        question: "The report was ___ written by the manager.",
      ...
      {
        question: "The box was ___ heavy that I couldn't lift it.",
    ...
    medium2: [
      {
        question: "The data ___ still being analyzed by the experts.",
        options: ["are", "is", "was", "be"],
        correctAnswer: "are",
      ...
      {
        question: "Hardly had he left the house ___ it started pouring.",
      ...
      {
        question: "She succeeded in passing the exam ___ studying very little.",
      ...
      {
        question: "The results of the audit ___ not yet been released.",
      ...
      {
        question: "None of the money ___ spent on marketing.",
        options: ["was", "were", "are", "be"],
        correctAnswer: "was",
      ...
      {
        question: "He is used to ___ in a noisy environment.",
      ...
      {
        question: "She was one of the few who ___ selected for the scholarship.",
        options: ["were", "was", "is", "be"],
        correctAnswer: "were",
      ...
      {
        question: "If it ___ for your help, we wouldn't have succeeded.",
      ...
      {
        question: "___ you need any assistance, please dial zero.",
    ...
    hard1: [
      {
        question: "Were I ___ the truth, I would have told you.",
      ...
      {
        question: "The government recommended that the tax rates ___ reduced.",
      ...
      {
        question: "No sooner had she entered the room ___ she noticed the leak.",
      ...
      {
        question: "He is the candidate ___ we believe will win the election.",
      ...
      {
        question: "They had ___ completed the work when the electricity cut out.",
      ...
      {
        question: "Not only ___ the game, but they also set a record.",
      ...
      {
        question: "She was determined, ___ the opposition of her family.",
      ...
      {
        question: "The criteria for evaluation ___ extremely strict.",
        options: ["were", "was", "is", "be"],
        correctAnswer: "were",
      ...
      {
        question: "___ he to fail the test, he would have to repeat the grade.",
    ...
    hard2: [
      {
        question: "Lest they ___ detected, they moved in complete silence.",
      ...
      {
        question: "Only after he had finished the letter ___ he realize his mistake.",
      ...
      {
        question: "Under no circumstances ___ the door be opened.",
      ...
      {
        question: "Had we known the severity of the situation, we ___ differently.",
      ...
      {
        question: "She was highly praised, ___ so because of her dedication.",
      ...
      {
        question: "Such ___ the beauty of the island that we decided to stay.",
        options: ["was", "were", "is", "be"],
        correctAnswer: "was",
      ...
      {
        question: "None of the evidence ___ presented in court.",
        options: ["was", "were", "are", "be"],
        correctAnswer: "was",
      ...
      {
        question: "The alumni ___ gathered for the reunion dinner.",
        options: ["were", "was", "is", "be"],
        correctAnswer: "were",
      ...
      {
        question: "So quickly ___ the years pass that we forget our childhood.",
      ...
      {
        question: "The phenomena observed during the eclipse ___ unexplained.",
