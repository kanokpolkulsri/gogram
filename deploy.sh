...
gcloud run deploy gogram-api --source ./server --platform managed --region asia-southeast1 --allow-unauthenticated --project gogram-web-2026 || { echo "❌ Cloud Run deployment failed"; exit 1; }
